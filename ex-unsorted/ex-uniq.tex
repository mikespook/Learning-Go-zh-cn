...
\lstinputlisting[label=src:uniq,caption=uniq(1) in Perl,language=Perl]{ex-unsorted/src/uniq.pl}

\end{Exercise}

\begin{Answer}
\Question The following is a uniq implementation in Go.
\lstinputlisting[caption=uniq(1) in Go]{ex-unsorted/src/uniq.go}
\end{Answer}
