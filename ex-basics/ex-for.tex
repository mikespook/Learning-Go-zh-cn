...
\lstinputlisting[label=src:for]{ex-basics/src/for.go}
...
\Question 
The following might one possible solution:
\lstinputlisting[label=src:for-arr,linerange={5,11}]{ex-basics/src/for-arr.go}
