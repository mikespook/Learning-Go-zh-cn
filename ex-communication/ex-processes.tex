...
\vskip\baselineskip
\begin{display}
Pid 0 has 2 childeren: 1 2
Pid 490 has 2 childeren: 1199 26524
...
more than one print \verb|childeren|;}
...
and utter confusion).
\lstinputlisting[caption=Processes in Perl,language=Perl]{ex-communication/src/proc.pl}
\end{Exercise}
...
The function \func{atoi} (lines 19 through 22) is defined to get ride of the multiple return
