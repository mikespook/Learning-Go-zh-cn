...
\key{defer} you specify a function which is called just \emph{after} the
\key{return} \emph{statement} from the function is executed, but before the function returns.
