...
to us in the form of \first{channels}. A \first{channel} can be
...
\end{lstlisting}
\showremarks
There is still some remaining uglyness; we have to read twice from
...
Go built-in comes in: \first{\key{select}}. With \key{select} you 
can BLA BLA TODO(miekg).
