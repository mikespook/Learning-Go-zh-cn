...
compared to a two-way pipe in Unix shells. You can send and receive
values to and from it. Those values can only be of a specific type: the
...
The uglyness is now contained in the last few lines (lines 14 and 15),
