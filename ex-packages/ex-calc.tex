...
package you found for question \ref{ex:stack-package q2} of exercise Q\ref{ex:calc}
\end{Exercise}

\begin{Answer}
\Question This is one answer
\lstinputlisting[caption=A (rpn) calculator,basicstyle=\tiny\ttfamily]{ex-packages/src/calc.go}
