...
This is a concise instruction on how to get your code compiled and get
it to run.
\begin{display}
...
\noindent\texttt{types.go:7: cannot use a + a (type int)  as type int32 in assignment}
...
iota, and more about constants\todo{xxx}

\subsection{Complex numbers}
In Go there is native support for complex numbers. If you 
