...
In the following paragraphs and chapters we will explain them. \todo{}
...
a channel, a \key{range} clause can manage the loop for you. A
\key{range} returns two values, the index or key and the 
corresponding value.
\begin{lstlisting}
