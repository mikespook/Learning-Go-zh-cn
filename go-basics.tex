...
a channel, a \key{range} clause help you again.
\begin{lstlisting}
year := 0
...
\section{Allocation}
In all the example in the above paragraph we typed in the entire array,
slice or map. But what if you want to fill these dynamically? Then you
need to use \func{make}. 

Allocating with make. What sshould this mbne
