...
\func{new}, \func{make}, \func{copy} and \func{append}
make their appearance in chapter
\ref{chap:beyond}.
\index{built-in!copy}
\index{built-in!append}
\todo{copy isn't handled there}
...
% > From the release of notes of Go release.2010-10-27
