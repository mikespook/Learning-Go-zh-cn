...
*string := flag.String("port", "53", "Set the query port")      |\longremark{Idem, but for a \texttt{port} option;}|
...
buf, err := cmd.Ouput()                 |\coderemark{Retuns stdout in \var{buf} (a \type{[]byte}}|
\end{lstlisting}
