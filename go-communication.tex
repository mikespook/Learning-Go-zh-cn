...
\end{lstlisting}
\end{minipage}
%% tell some more about the above examples
...
\end{lstlisting}
Capturing standard output from a command is done as follows:
\begin{lstlisting}
import "os/exec"
...
\type{io.ReadWriter}.\footnote{In fact \var{conn} also implements a \func{close} method, this really makes
