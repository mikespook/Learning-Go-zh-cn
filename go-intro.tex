...
\item Longer remarks get a number - \gocircle{1} - which the explanation following;
...
this:
\lstinputlisting[label=src:short,caption=Shortest Go program]{src/short.go}
...
\section{Constant types and values} %% also check go-basics
...
%%  compile code, compile your own package
