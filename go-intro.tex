...
\begin{itemize}
\item Code is displayed in \prog{Source Code Pro};
\item Keywords are displayed in \key{Source Code Pro Bold};
\item Comments are displayed in \rem{Source Code Pro};
