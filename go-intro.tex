...
\todo{We don't explain how to read this in that chapter.}
...
\end{display}
That would be \texttt{release.2010-10-20}.
...
\func{write()} system calls work as well on normal files as they do on I/O
