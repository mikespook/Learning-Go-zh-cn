\epi{"Semi funny quote"}
{\textit{ref-to-doc}\\ \textsc{Person Name}}
...
A short introduction and history of Go. It also
...
Communication with those goroutines is done via channels. In chapter \ref{chap:channels} we
see how this all works.

\item[Chapter \ref{chap:communication}: \titleref{chap:communication}] 
And in the last chapter show how to interface with the rest of the world from within 
