...
\lstinputlisting[language=make,caption=A Makefile for package]{src/Makefile}
...
tests involves the \package{testing} and the program \prog{gotest}. Both
have excellent documentation. When you include tests with your package
keep in mind that has to be build using the standard \prog{Makefile}
