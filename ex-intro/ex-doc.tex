...
\label{ex:doc}
\Question
Go's documentation can be read with the \prog{godoc}, \prog{godoc hash}
gives information about the \package{hash} package. Reading the
...
instance the function \func{Printf} is decribed in \package{fmt}, but to
