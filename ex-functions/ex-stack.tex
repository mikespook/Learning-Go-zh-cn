...
use the damn thing. \emph{First we show the \emph{wrong}{} solution!}
...
\lstinputlisting[firstline=13,lastline=28,caption=The push and pop functions]{ex-functions/src/stack.go}
Which we then use as follows
\lstinputlisting[firstline=39,lastline=44,caption=Stack usage]{ex-functions/src/stack.go}
...
our type:
\lstinputlisting[firstline=30,lastline=37,caption=stack.String()]{ex-functions/src/stack.go}
\end{Answer}
