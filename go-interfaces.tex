...
\end{lstlisting}
When we call this function with \lstinline|sort([]int{1, 4, 5})|, it
fails with
...
\type{string} (or whatever) to an interface, this is very easy to
...
\gomarginpar{For those interested the full thread discussing this, it can be 
found at \cite{go_nuts_interfaces}.}
