...
\end{lstlisting}
\showremarks
Note that a type switch \emph{isn't} the only way (see section "\titleref{sec:checking for interfaces}"
in this chapter)
to figure out what type of an interface variable is. Using
...
\label{sec:checking for interfaces}
